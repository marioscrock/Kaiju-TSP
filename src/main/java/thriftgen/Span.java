...
public class Span implements org.apache.thrift.TBase<Span, Span._Fields>, java.io.Serializable, Cloneable, Comparable<Span> {
  ...
  public java.lang.String operationName; // required
  public java.util.List<SpanRef> references; // optional
  public int flags; // required
  public long startTime; // required
  public long duration; // required
  public java.util.List<Tag> tags; // optional
  public java.util.List<Log> logs; // optional
  ...
  public Span setReferences(java.util.List<SpanRef> references) {
  ...
  public Span setTags(java.util.List<Tag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public Span setLogs(java.util.List<Log> logs) {
    this.logs = logs;
    return this;
  }
